                     ...
                     <div class="iq-card iq-card-block iq-card-stretch iq-card-height blog blog-detail">
                        <div class="iq-card-body">
                           <div class="image-block">
                              <img src="images/blog/01.jpg" class="img-fluid rounded w-100" alt="blog-img">  
                           </div>
                           ...
                           <ul class="list-inline p-0 mb-0 mt-2">
                              ...
                              <li class="mb-3">
                                 <div class="d-flex align-items-top pb-3 border-bottom">
                                    <div class="col-md-5">
                                       <div class="image-block">
                                          <img src="images/blog/04.jpg" class="img-fluid rounded w-100" alt="blog-img">
                                       </div>
                                    </div>
                                    <div class="col-md-7">
                                       <div class="blog-description pl-2">
                              ...
                              <li class="mb-3">
                                 <div class="d-flex align-items-top pb-3 border-bottom">
                                    <div class="col-md-5">
                                       <div class="image-block">
                                          <img src="images/blog/05.jpg" class="img-fluid rounded w-100" alt="blog-img">
                                       </div>
                                    </div>
                                    <div class="col-md-7">
                                       <div class="blog-description pl-2">
                              ...
                              <li class="mb-3">
                                 <div class="d-flex align-items-top pb-3 border-bottom">
                                    <div class="col-md-5">
                                       <div class="image-block">
                                          <img src="images/blog/06.jpg" class="img-fluid rounded w-100" alt="blog-img">
                                       </div>
                                    </div>
                                    <div class="col-md-7">
                                       <div class="blog-description pl-2">
                              ...
                              <li class="mb-3">
                                 <div class="d-flex align-items-top pb-3 border-bottom">
                                    <div class="col-md-5">
                                       <div class="image-block">
                                          <img src="images/blog/07.jpg" class="img-fluid rounded w-100" alt="blog-img">
                                       </div>
                                    </div>
                                    <div class="col-md-7">
                                       <div class="blog-description pl-2">
                              ...
                              <li>
                                 <div class="d-flex align-items-top">
                                    <div class="col-md-5">
                                       <div class="image-block">
                                          <img src="images/blog/08.jpg" class="img-fluid rounded w-100" alt="blog-img">
                                       </div>
                                    </div>
                                    <div class="col-md-7">
                                       <div class="blog-description pl-2">
                                    ...
                                    <div class="iq-card-body">
                                       <div class="d-flex align-items-center">
                                          <div class="user-image mb-3">
                                             <img class="avatar-80 rounded" src="images/user/01.jpg" alt="#" data-original-title="" title="">
                                          </div>
                                          <div class="ml-3">
                              ...
                              <div class="col-lg-12 pl-5">
                                 <div class="iq-card iq-card-block iq-card-stretch iq-card-height blog">
                                    <div class="iq-card-body">
                                       <div class="d-flex align-items-center">
                                          <div class="user-image mb-3">
                                             <img class="avatar-80 rounded" src="images/user/02.jpg" alt="#" data-original-title="" title="">
                                          </div>
                                          <div class="ml-3">
                                             <h5>Tom Cruise</h5>
                                             <p>Web Designer</p>
                              ...
                              <div class="col-lg-12">
                                 <div class="iq-card iq-card-block iq-card-stretch iq-card-height blog">
                                    <div class="iq-card-body">
                                       <div class="d-flex align-items-center">
                                          <div class="user-image mb-3">
                                             <img class="avatar-80 rounded" src="images/user/03.jpg" alt="#" data-original-title="" title="">
                                          </div>
                                          <div class="ml-3">
                                             <h5>Walter Hucko</h5>
                                             <p>Web Designer</p>
                              ...
                              <div class="col-lg-12 pl-5">
                                 <div class="iq-card iq-card-block iq-card-stretch iq-card-height blog">
                                    <div class="iq-card-body">
                                       <div class="d-flex align-items-center">
                                          <div class="user-image mb-3">
                                             <img class="avatar-80 rounded" src="images/user/04.jpg" alt="#" data-original-title="" title="">
                                          </div>
                                          <div class="ml-3">
                                             <h5>Tom Cruise</h5>
                                             <p>Web Manager</p>
